# AGENTS.md - HTML Entity Encoder

Single-purpose static tool: Encode and decode HTML entities safely in your browser. Part of the crusher-labs **static tools line** (frozen). Hosted on GitHub Pages at https://crusher-labs.github.io/html-entity-encoder/
