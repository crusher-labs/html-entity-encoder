...
Encode and decode HTML entities safely in your browser.

Live: <https://crusher-labs.github.io/html-entity-encoder/>
...
- Or serve the parent workspace via the hub's preview server: `cd ../../tools-hub && npm run preview` then visit `http://127.0.0.1:8723/utility-tools/html-entity-encoder/`.
