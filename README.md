# HTML Entity Encoder/Decoder (moved)

This tool now lives at <https://tools.muhammadhassaanjaved.com/html-entity-encoder/> as part of the consolidated tools site.
...
This repo keeps its history and serves a redirect. The source now lives in [tools-hub](https://github.com/crusher-labs/tools-hub) under `html-entity-encoder/`.
